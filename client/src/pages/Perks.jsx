...
export default function Perks({selected,onChange}) {
    ...
    return (
        <>
             <label className="border flex rounded-2xl p-4">
                <input type="checkbox"  checked={selected.includes('wifi')} name="wifi" className="flex" onChange={handleClick} />
                    ...
                    <label className="border flex rounded-2xl p-4">
                        <input type="checkbox"  checked={selected.includes('free')} name="free" onChange={handleClick}/>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
